...
- **에피소드 학습** — 장면별 상황 브리핑(유튜브 원장면 링크) + 표현 카드 + 대화 롤플레이 + 스피킹 드릴 + 딕테이션
- **표현 심화** — 표현마다 실전 변형 3종 · 한국인이 자주 틀리는 포인트 · 발음(연음/강세) 해설
- **듣기(TTS)** — 문장별/전체 재생, 0.75배속 천천히 듣기 (Web Speech API)
- **롤플레이(STT)** — 배역을 골라 내 대사를 말하면 단어 매칭 채점 + 놓친 단어 피드백 (Chrome/Edge)
- **스피킹 드릴** — 한국어 상황만 보고 영어로 말하기 → 키워드 채점 → 모범 답안 (능동 회상 훈련)
- **딕테이션** — 핵심 문장을 듣고 받아쓰기, 단어 단위 채점
- **퀴즈** — 뜻 / 상황 / 듣기 / 빈칸 4유형 순환, 회차별·전체 랜덤 8문항
- **복습** — Leitner 3-box SRS 플래시카드, 뜻 회상(EN→KR)·말하기(KR→EN) 양방향 모드
- **오늘의 플랜** — 장면 1 · 복습 비우기 · 퀴즈, 일일 체크리스트로 학습 루틴 형성
